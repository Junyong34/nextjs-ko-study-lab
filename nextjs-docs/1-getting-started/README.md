...
> Next.js App Router의 기초를 익히고 프로젝트 구조를 직접 구성하는 입문 과정입니다.
...
- App Router의 레이아웃 시스템과 Server Component, Client Component의 차이를 구분합니다.
- 데이터 페칭, 변이, 캐싱 및 무효화의 기본 동작을 실습으로 익힙니다.
...
- 1.4 [Linking and Navigating](./linking-and-navigating.md): 클라이언트 내비게이션과 prefetching
- 1.5 [Server and Client Components](./server-and-client-components.md): Server Component와 Client Component의 경계
...
- 1.9 [Revalidating](./revalidating.md): 캐시 무효화 및 데이터 revalidation
