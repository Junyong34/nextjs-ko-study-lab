...
| 3.3.8 | root-params | [공식](https://nextjs.org/docs/app/api-reference/functions/next-root-params) | 완료 | 미착수 |
| 3.3.9 | fetch | [공식](https://nextjs.org/docs/app/api-reference/functions/fetch) | 완료 | 미착수 |
| 3.3.10 | cookies | [공식](https://nextjs.org/docs/app/api-reference/functions/cookies) | 완료 | 미착수 |
| 3.3.11 | headers | [공식](https://nextjs.org/docs/app/api-reference/functions/headers) | 완료 | 미착수 |
| 3.3.12 | draftMode | [공식](https://nextjs.org/docs/app/api-reference/functions/draft-mode) | 완료 | 미착수 |
| 3.3.13 | cacheLife | [공식](https://nextjs.org/docs/app/api-reference/functions/cacheLife) | 완료 | 미착수 |
| 3.3.14 | cacheTag | [공식](https://nextjs.org/docs/app/api-reference/functions/cacheTag) | 완료 | 미착수 |
| 3.3.15 | unstable_cache | [공식](https://nextjs.org/docs/app/api-reference/functions/unstable_cache) | 완료 | 미착수 |
| 3.3.16 | unstable_noStore | [공식](https://nextjs.org/docs/app/api-reference/functions/unstable_noStore) | 완료 | 미착수 |
| 3.3.17 | revalidatePath | [공식](https://nextjs.org/docs/app/api-reference/functions/revalidatePath) | 완료 | 미착수 |
| 3.3.18 | revalidateTag | [공식](https://nextjs.org/docs/app/api-reference/functions/revalidateTag) | 완료 | 미착수 |
| 3.3.19 | updateTag | [공식](https://nextjs.org/docs/app/api-reference/functions/updateTag) | 완료 | 미착수 |
| 3.3.20 | connection | [공식](https://nextjs.org/docs/app/api-reference/functions/connection) | 완료 | 미착수 |
| 3.3.21 | io | [공식](https://nextjs.org/docs/app/api-reference/functions/io) | 완료 | 미착수 |
| 3.3.22 | after | [공식](https://nextjs.org/docs/app/api-reference/functions/after) | 완료 | 미착수 |
| 3.3.23 | notFound | [공식](https://nextjs.org/docs/app/api-reference/functions/not-found) | 완료 | 미착수 |
| 3.3.24 | forbidden | [공식](https://nextjs.org/docs/app/api-reference/functions/forbidden) | 완료 | 미착수 |
| 3.3.25 | unauthorized | [공식](https://nextjs.org/docs/app/api-reference/functions/unauthorized) | 완료 | 미착수 |
| 3.3.26 | redirect | [공식](https://nextjs.org/docs/app/api-reference/functions/redirect) | 완료 | 미착수 |
| 3.3.27 | permanentRedirect | [공식](https://nextjs.org/docs/app/api-reference/functions/permanentRedirect) | 완료 | 미착수 |
| 3.3.28 | catchError | [공식](https://nextjs.org/docs/app/api-reference/functions/catchError) | 완료 | 미착수 |
| 3.3.29 | refresh | [공식](https://nextjs.org/docs/app/api-reference/functions/refresh) | 완료 | 미착수 |
| 3.3.30 | unstable_rethrow | [공식](https://nextjs.org/docs/app/api-reference/functions/unstable_rethrow) | 완료 | 미착수 |
| 3.3.31 | NextRequest | [공식](https://nextjs.org/docs/app/api-reference/functions/next-request) | 완료 | 미착수 |
