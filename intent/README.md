...
| `search-favicon-parity` | 구글 검색 결과 사이트 아이콘, 파비콘, apple-touch-icon | `nextjs-app/apps/shell/src/app/apple-icon.tsx`, `nextjs-app/apps/shell/src/app/icon.svg` | approved | [`intent.md`](./search-favicon-parity/intent.md) | [`intent.md#requirements`](./search-favicon-parity/intent.md#requirements) | [`plan.md`](./search-favicon-parity/plan.md) | 사용자 승인 완료, 구현 중 |
