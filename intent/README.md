...
| `practice-page-refiner-forms-cache` | useActionState, useFormStatus, cacheTag, revalidateTag, revalidatePath의 실제 동작·검증 재구성 | `nextjs-app/apps/demo-baseline/src/app/zone/baseline/guides/forms/`, `nextjs-app/apps/demo-cache-components/src/app/zone/cache/functions/{cache-tag,revalidate-tag,revalidate-path}/`, `nextjs-app/packages/demos/demos.yaml` | draft | [`intent.md`](./practice-page-refiner-forms-cache/intent.md) | — | — | intent 초안. PO 승인 및 병합 전이며 구현·공개 상태 변경은 시작하지 않음 |
