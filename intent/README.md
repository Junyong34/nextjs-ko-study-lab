...
| `visualize-seo-keywords` | 시각화 갤러리(`/visualize`) SEO 메타데이터 keywords, title 이중 접미사, sitemap 등록 | `nextjs-app/apps/shell/src/lib/seo/metadata.ts`, `nextjs-app/apps/shell/src/app/visualize/`, `nextjs-app/apps/shell/src/app/sitemap.ts`, `nextjs-app/packages/ui/src/reference-visualize/toolkit/examples/showcase-*.tsx` | approved | [`intent.md`](./visualize-seo-keywords/intent.md) | [`intent.md#requirements`](./visualize-seo-keywords/intent.md#requirements) | [`plan.md`](./visualize-seo-keywords/plan.md) | 대화 승인 후 구현·타입·빌드·런타임·sitemap 검증 완료. PR 머지 전 승인 효력 없음 |
| `visualize-view-ga-event` | `/visualize/[slug]` 진입 GA4 커스텀 이벤트(`visualize_view`), `demo_view` 패턴 미러링 | `nextjs-app/apps/shell/src/lib/analytics.ts`, `nextjs-app/apps/shell/src/components/visualize/VisualizeViewTracker.tsx`, `.../VisualizeDetailViewer.tsx` | approved | [`intent.md`](./visualize-view-ga-event/intent.md) | [`intent.md#requirements`](./visualize-view-ga-event/intent.md#requirements) | [`plan.md`](./visualize-view-ga-event/plan.md) | 대화 승인 후 구현·타입·빌드 검증 완료. 브라우저 dataLayer 확인은 chrome-devtools-mcp 프로필 충돌로 미실행. PR 머지 전 승인 효력 없음 |
