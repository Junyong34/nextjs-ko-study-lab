...
export const metadata: Metadata = getDemoMetadata('baseline', 'file-conventions/loading/skeleton-boundary')
  ...
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        ...
        concept={"slow-catalog 세그먼트에 loading.tsx를 두면 Next.js가 그 세그먼트를 Suspense로 자동 래핑하여, 1200ms 비동기 지연 동안 스켈레톤 UI를 먼저 스트리밍합니다."}
        steps={[
        {
        "step": 1,
        ...
        "description": "데이터가 준비되면 스켈레톤이 실제 상품 3건으로 교체됩니다.",
        "actionBadge": "스트리밍 완료",
