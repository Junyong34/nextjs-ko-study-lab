  ...
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        ...
        concept={"쇼핑몰 라우팅 계층에서 Next.js 특수 파일 컨벤션 'SSE 실시간 재고 스트리밍 (route.ts)'을 적용하여 URL 구조와 렌더링 수명 주기를 제어하는 실습입니다."}
        steps={[
          {
                    "step": 1,
                    "title": "라우트 파일 컨벤션 확인",
      ...
      />
      <DemoPlaygroundCard title={"SSE 실시간 재고 스트리밍 (route.ts) 실습"}>
        <SseStockStreamDemo />
      </DemoPlaygroundCard>
      <VerificationFooter />
    </DemoContainer>
