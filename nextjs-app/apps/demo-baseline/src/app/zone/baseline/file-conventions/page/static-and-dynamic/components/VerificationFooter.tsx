...
export function VerificationFooter(props: VerificationFooterProps = {}) {
  ...
  const defaultExpected = "• 정적(Static)과 다이나믹(Dynamic) page.tsx 렌더링의 동작과 기대 결과를 확인합니다."
  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        title="정적(Static)과 다이나믹(Dynamic) page.tsx 렌더링 검증 결과"
        expected={propExpected || defaultExpected}
        actual={actualContent}
        isMatched={isMatched}
        description={propDescription || "이 예제의 동작과 검증 결과를 표시합니다."}
      />
      <DemoDeepDiveCard title="정적(Static)과 다이나믹(Dynamic) page.tsx 렌더링 수명 주기">
