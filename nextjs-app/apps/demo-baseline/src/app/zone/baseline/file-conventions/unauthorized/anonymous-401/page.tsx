...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"미인증 세션 401 로그인 요구 화면 (unauthorized.tsx)"}
        concept={"쇼핑몰 라우팅 계층에서 Next.js 특수 파일 컨벤션 '미인증 세션 401 로그인 요구 화면 (unauthorized.tsx)'을 적용하여 URL 구조와 렌더링 수명 주기를 제어하는 실습입니다."}
        steps={[
          {
                    "step": 1,
                    "title": "라우트 파일 컨벤션 확인",
