...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"루트 레이아웃(Root Layout) 및 카테고리 중첩 레이아웃"}
        concept={"쇼핑몰 라우팅 계층에서 Next.js 특수 파일 컨벤션 '루트 레이아웃(Root Layout) 및 카테고리 중첩 레이아웃'을 적용하여 URL 구조와 렌더링 수명 주기를 제어하는 실습입니다."}
        steps={[
          {
                    "step": 1,
                    "title": "라우트 파일 컨벤션 확인",
