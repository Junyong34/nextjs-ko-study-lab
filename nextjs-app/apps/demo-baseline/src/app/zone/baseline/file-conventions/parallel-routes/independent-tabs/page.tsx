    ...
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        ...
        steps={[
          {
                    "step": 1,
                    "title": "첫 번째 슬롯 탭 전환 및 두 번째 슬롯 탭 전환",
                    "description": "대시보드 슬롯 내부의 하위 탭으로 이동하여 해당 슬롯만 갱신합니다. 메트릭스 슬롯 내부의 기간 탭을 변경하여 독립적으로 데이터를 로드합니다.",
                    "actionBadge": "슬롯 1 이동"
          },
          {
                    "step": 2,
                    "title": "슬롯 간 상태 격리 확인",
                    "description": "한쪽 슬롯의 이동이 다른 쪽 슬롯의 렌더링 상태를 초기화하지 않는지 확인합니다.",
                    "actionBadge": "상태 격리",
                    "observe": "3단 검증 패널에서 두 병렬 슬롯의 독립 네비게이션 상태가 올바르게 보존되는지 확인",
