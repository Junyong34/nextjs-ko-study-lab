    ...
    <DemoContainer className="space-y-6">
      ...
      <DemoGuideCard
        ...
        steps={[
          {
                    "step": 1,
                    "title": "@theme CSS 변수 기반 Tailwind v4 설정 확인",
                    "description": "최신 Tailwind CSS v4의 @theme 지시어 및 디자인 토큰 선언을 확인합니다.",
          ...
          },
          {
                    ...
                    "observe": "Tailwind v4 유틸리티 클래스가 순수 CSS 변수와 결합되어 0ms 즉각적인 UI 상태 변화를 렌더링함",
