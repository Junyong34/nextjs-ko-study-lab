  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        ...
        expected="• Route Handler 내 redirect() (307 Temporary Redirect) 사양에 따른 정상 동작 및 상태 변화 관찰"
        actual="• 실시간 인터랙션 및 상태 동기화 완료\n• 4단 표준 레이아웃 정상 적용"
        isMatched={true}
        description="Next.js App Router 공식 표준 스펙 및 실무 이커머스 도메인 규칙을 기반으로 기술 동작을 검증했습니다."
      />
      <DemoDeepDiveCard title="Route Handler 내 redirect() (307 Temporary Redirect)">
