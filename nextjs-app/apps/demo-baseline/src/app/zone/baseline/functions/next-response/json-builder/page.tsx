  ...
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        ...
        concept={"쇼핑몰의 주문/회원/카탈로그 비즈니스 로직에서 Next.js 내장 함수 'NextResponse.json() 응답 빌더 및 상태 코드 주입'을 활용하는 실무 개발 패턴입니다."}
        steps={[
          {
                    "step": 1,
      ...
      />
      <DemoPlaygroundCard title={"NextResponse.json() 응답 빌더 및 상태 코드 주입 실습"}>
