...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"useServerInsertedHTML SSR 인라인 스타일/스크립트 주입"}
        concept={"쇼핑몰의 주문/회원/카탈로그 비즈니스 로직에서 Next.js 내장 함수 'useServerInsertedHTML SSR 인라인 스타일/스크립트 주입'을 활용하는 실무 개발 패턴입니다."}
        steps={[
          {
                    "step": 1,
