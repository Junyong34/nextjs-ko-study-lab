...
export function VerificationFooter(props: VerificationFooterProps = {}) {
  ...
  const defaultExpected = "• useRouter push, replace, back 프로그래밍 방식 내비게이션의 동작과 기대 결과를 확인합니다."
  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        title="useRouter push, replace, back 프로그래밍 방식 내비게이션 검증 결과"
        ...
        <div className="space-y-3.5 text-xs leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-zinc-600 dark:text-zinc-400 pl-1">
              ...
              <li><strong>Link 컴포넌트 우선 원칙</strong>: 단순 앵커 내비게이션의 경우 SEO 크롤링 및 자동 prefetching 이점을 위해 <code>useRouter</code> 대신 <code>{'<'}Link{'>'}</code> 컴포넌트를 사용하는 것이 권장됩니다.</li>
            </ul>
          </div>
        </div>
      </DemoDeepDiveCard>
