...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"Route Handler를 통한 레거시 주문/재고 API 취합 (BFF)"}
        concept={"쇼핑몰 플랫폼의 실무 기능인 'Route Handler를 통한 레거시 주문/재고 API 취합 (BFF)' 구현을 위해 Next.js의 고급 가이드 아키텍처와 최적화 기법을 적용한 실습 예제입니다."}
        steps={[
          {
                    "step": 1,
                    "title": "쇼핑몰 시나리오 초기화",
