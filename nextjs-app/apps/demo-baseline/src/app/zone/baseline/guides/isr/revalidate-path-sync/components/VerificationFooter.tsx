...
export function VerificationFooter(props: VerificationFooterProps = {}) {
  ...
  const defaultExpected = "• revalidatePath에 따른 라우트 범위별 무효화의 동작과 기대 결과를 확인합니다."
  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        title="revalidatePath에 따른 라우트 범위별 무효화 검증 결과"
        expected={propExpected || defaultExpected}
        actual={actualContent}
        isMatched={isMatched}
        description={propDescription || "이 예제의 동작과 검증 결과를 표시합니다."}
      />
                        <DemoDeepDiveCard title="revalidatePath에 따른 라우트 범위별 무효화">
