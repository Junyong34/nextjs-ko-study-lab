...
export function AdvancedActionForm() {
  ...
  const finalPrice = state.success && state.discountAmount
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 2. Server Action 폼 */}
      <form action={formAction} className="space-y-3 rounded-md border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900/50">
        <div>
