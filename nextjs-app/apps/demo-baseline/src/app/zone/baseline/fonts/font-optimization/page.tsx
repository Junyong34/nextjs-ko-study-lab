  ...
  return (
    <DemoContainer className="space-y-6">
      ...
      <DemoGuideCard
        ...
        concept="next/font는 Google Fonts 및 로컬 WOFF2 폰트를 빌드 타임에 자동 다운로드하여 셀프호스팅(외부 DNS 요청 0건)하고, size-adjust CSS 보정으로 폰트 로딩 중 레이아웃 흔들림(CLS 0)을 완벽 방지합니다."
        steps={[
          {
            step: 1,
          ...
          {
            step: 2,
            title: '[700] 및 [900] 굵기(weight) 버튼 클릭',
          ...
          },
          {
            ...
            description: '외부 fonts.googleapis.com 요청이 제거되고 CSS size-adjust로 레이아웃 이동 없이 즉각 렌더링되는 것을 관찰합니다.',
            actionBadge: 'Zero CLS 검증',
            observe: '외부 CDN 요청 없이 동일 도메인에서 가변 폰트가 로드되며 굵기(400/700/900) 변경이 0ms 즉각 반영됨',
