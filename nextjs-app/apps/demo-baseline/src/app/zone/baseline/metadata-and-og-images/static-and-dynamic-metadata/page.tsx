    ...
    <DemoContainer className="space-y-6">
      ...
      <DemoGuideCard
        ...
        steps={[
          ...
          {
            step: 2,
            title: '[상품 프리셋] 선택 및 동적 generateMetadata() 생성 확인',
            description: '상품 프리셋 버튼을 클릭하여 파라미터별 og:title, og:description이 동적으로 생성되는지 확인합니다.',
            actionBadge: '동적 OG 생성',
          },
          {
            step: 3,
            title: '[카카오톡], [X (Twitter)], [페이스북] 미리보기 탭 선택',
          ...
          },
          {
            ...
            observe: '선택된 상품 및 수정한 og:title/og:description에 따라 SNS 공유 카드와 <head> 메타 태그 인스펙터가 실시간 갱신됨',
