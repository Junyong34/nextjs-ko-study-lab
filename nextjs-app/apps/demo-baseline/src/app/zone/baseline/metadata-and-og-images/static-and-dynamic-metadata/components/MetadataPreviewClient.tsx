...
export function MetadataPreviewClient({
  ...
  const [selectedPresetId, setSelectedPresetId] = useState('course-main')
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2 rounded-md border border-zinc-200 bg-zinc-50 p-3 text-xs dark:border-zinc-800 dark:bg-zinc-900/50">
          <span className="font-semibold text-zinc-700 dark:text-zinc-300">상품 프리셋:</span>
          {PRESETS.map((preset) => (
            <button
              key={preset.id}
              type="button"
