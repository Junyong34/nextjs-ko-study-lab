    ...
    <DemoContainer className="space-y-6">
      ...
      <DemoGuideCard
        ...
        steps={[
          {
            step: 1,
            title: '[GET 전체 목록 조회] 버튼 클릭',
            description: '상단 툴바에서 GET 요청 버튼을 클릭하여 200 OK 응답과 전체 상품 목록 JSON 데이터를 확인합니다.',
            actionBadge: 'GET 조회',
          },
          {
            step: 2,
            title: '[POST 상품 등록 (+1)] 및 [PATCH 1번 상품 품절 처리] 버튼 클릭',
            description: 'POST로 새 상품을 추가(201 Created)하거나 PATCH로 특정 상품 상태를 품절로 변경합니다.',
            actionBadge: 'POST/PATCH 실행',
          },
          {
            step: 3,
            title: '[DELETE 2번 상품 삭제] 클릭 및 응답 관찰',
            description: 'DELETE 요청을 전송하여 상품을 삭제하고 HTTP 200 상태 코드 및 삭제 결과 페이로드를 대조 관찰합니다.',
