...
export const metadata: Metadata = getDemoMetadata('baseline', 'error-handling/global-error')
    ...
    <DemoContainer className="space-y-6">
      ...
      <DemoGuideCard
        ...
        steps={[
          {
            step: 1,
            title: '[잘못된 이메일 (예: invalid-email)] 폼 입력 및 [주문 제출]',
            description: '이메일 입력창에 잘못된 형식을 입력하고 [주문 제출]을 클릭하여 400 검증 에러 반환 동작을 확인합니다.',
            actionBadge: '예상된 에러 (400)',
          },
          {
            step: 2,
            title: '[2. 세그먼트 예외 던지기 시뮬레이션] 클릭',
            description: '하위 세그먼트에서 발생한 예외가 상위 레이아웃을 파괴하지 않고 segment error.tsx에 격리 포착되는 것을 확인합니다.',
            actionBadge: 'error.tsx 포착',
          },
          {
            step: 3,
            title: '[3. 루트 레이아웃 크래시 시뮬레이션] 클릭',
            description: 'Root Layout 수준의 치명적 결함 발생 시 최상위 global-error.tsx가 전체 앱을 안전 폴백으로 감싸는 것을 관찰합니다.',
            actionBadge: 'global-error.tsx',
