...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"모달 다이얼로그 키보드 포커스 트랩(Focus Trap) 및 Esc 닫기"}
        concept={"쇼핑몰 엔터프라이즈 환경 설정을 위한 '모달 다이얼로그 키보드 포커스 트랩(Focus Trap) 및 Esc 닫기' 구성을 next.config.ts 및 아키텍처 레벨에서 실증하는 데모입니다."}
        steps={[
          {
                    "step": 1,
                    "title": "설정 프로파일 점검",
