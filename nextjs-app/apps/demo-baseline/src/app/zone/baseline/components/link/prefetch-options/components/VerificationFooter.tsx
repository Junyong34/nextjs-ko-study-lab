...
export function VerificationFooter(props: VerificationFooterProps = {}) {
  ...
  const defaultExpected = "• <Link prefetch> 옵션 대조 (auto vs full vs false) 사양에 따른 정상 동작 및 상태 변화 관찰"
  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        title="<Link prefetch> 옵션 대조 (auto vs full vs false) 실증 검증"
        ...
        <div className="space-y-3.5 text-xs leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-zinc-600 dark:text-zinc-400 pl-1">
              ...
              <li><strong>서버 부하 및 대역폭 제어</strong>: 무한 스크롤이나 수천 개의 링크가 있는 화면에서 불필요한 프리페치 요청을 차단하여 서버 부하를 방지합니다.</li>
              <li><strong>정적/동적 세그먼트 지능형 분리</strong>: <code>auto</code> 모드에서는 정적 레이아웃 셸만 먼저 프리페치하고 동적 데이터는 클릭 시점에 효율적으로 가져옵니다.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-zinc-600 dark:text-zinc-400 pl-1">
              ...
              <li>수천 개의 푸터 링크 및 모달 닫기 링크의 프리페치 차단 (<code>prefetch={'{'}false{'}'}</code>)</li>
              <li>상품 목록 카탈로그의 뷰포트 기반 기본 스마트 프리페치 (<code>auto</code>)</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-zinc-600 dark:text-zinc-400 pl-1">
              ...
              <li><strong>PPR(Partial Prerendering)과의 시너지</strong>: Next.js 최신 PPR 환경에서 <code>auto</code> 프리페치는 정적 셸만 신속히 가져와 메모리 효율을 극대화합니다.</li>
            </ul>
          </div>
        </div>
      </DemoDeepDiveCard>
