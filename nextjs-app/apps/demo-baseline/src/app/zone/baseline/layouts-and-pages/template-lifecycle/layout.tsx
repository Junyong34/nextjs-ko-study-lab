    ...
    <TemplateLifecycleProvider>
      <DemoContainer className="space-y-6">
        ...
        <DemoGuideCard
          ...
          concept="layout.tsx와 달리 template.tsx는 라우트 이동 시마다 기존 인스턴스를 언마운트하고 새로운 인스턴스를 생성(Re-mount)하여 폼 입력값과 애니메이션 상태를 자동 초기화합니다."
          steps={[
            {
              step: 1,
            ...
            {
              step: 2,
              title: '[오버핏 기모 맨투맨] 탭 클릭',
              description: '상단 탭 네비게이터에서 [오버핏 기모 맨투맨] 링크를 클릭하여 다른 상품 라우트로 이동합니다.',
              actionBadge: '라우트 이동',
            },
            {
              step: 3,
