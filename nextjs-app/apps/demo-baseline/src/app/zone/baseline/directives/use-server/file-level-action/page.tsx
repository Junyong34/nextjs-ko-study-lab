...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"파일 레벨 'use server' Server Action 모듈 분리"}
        concept={"React 19 및 Next.js 16의 지시어 '파일 레벨 'use server' Server Action 모듈 분리'을 사용하여 쇼핑몰 컴포넌트와 비동기 함수의 실행 경계 및 캐시 영역을 명시적으로 선언합니다."}
        steps={[
          {
                    "step": 1,
                    "title": "지시어 선언 위치 확인",
