...
export default function DemoPage() {
  return (
    <DemoContainer className="space-y-6">
      <DemoGuideCard
        title={"'use client' 클라이언트 경계 선언 및 이벤트 바인딩"}
        concept={"React 19 및 Next.js 16의 지시어 ''use client' 클라이언트 경계 선언 및 이벤트 바인딩'을 사용하여 쇼핑몰 컴포넌트와 비동기 함수의 실행 경계 및 캐시 영역을 명시적으로 선언합니다."}
        steps={[
          {
                    "step": 1,
                    "title": "지시어 선언 위치 확인",
