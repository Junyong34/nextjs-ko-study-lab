import { siteUrl, locale, ogImageSize, ogImageContentType } from '@study/demos'
 ...
 *
 * siteUrl/locale/ogImageSize/ogImageContentType은 demo-baseline, demo-cache-components와도
 * 공유하는 값이라 @study/demos(packages/demos/src/metadata.ts)에 단일 원본으로 두고 가져다 쓴다.
 */
...
export { ogImageSize, ogImageContentType }
