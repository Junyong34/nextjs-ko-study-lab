...
export const metadata: Metadata = {
  title: 'Cache Components 데모 카탈로그',
  description: `Next.js 16 use cache 및 Cache Components 실습 예제 카탈로그 (${cacheDemos.length}개 데모)`,
  openGraph: {
    type: 'website',
    locale: 'ko_KR',
    url: `${siteUrl}/`,
    siteName: 'Next.js 학습 데모',
    title: 'Cache Components 데모 카탈로그 | Next.js 학습',
    description: `Next.js 16 use cache 및 Cache Components 실습 예제 카탈로그 (${cacheDemos.length}개 데모)`,
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">
            Next.js 16 Cache Components 데모 카탈로그
          </h1>
          <p className="text-base text-zinc-600 dark:text-zinc-400 max-w-3xl leading-relaxed">
            Next.js 16의 새로운 캐싱 모델인 <code className="font-mono text-sm bg-zinc-200 dark:bg-zinc-800 px-1 py-0.5 rounded">use cache</code> 지시어, <code className="font-mono text-sm bg-zinc-200 dark:bg-zinc-800 px-1 py-0.5 rounded">cacheLife</code>, <code className="font-mono text-sm bg-zinc-200 dark:bg-zinc-800 px-1 py-0.5 rounded">cacheTag</code>, 그리고 컴포넌트/함수 수준 캐싱 실습 예제 총 {demos.length}개를 제공합니다.
          </p>
        ...
        <footer className="mt-16 border-t border-zinc-200 dark:border-zinc-800 pt-8 pb-12 text-center text-xs text-zinc-500 dark:text-zinc-400">
          <p className="mb-2">Next.js App Router 한국어 학습 랩 — Cache Components Zone</p>
          <a
            href={siteUrl}
