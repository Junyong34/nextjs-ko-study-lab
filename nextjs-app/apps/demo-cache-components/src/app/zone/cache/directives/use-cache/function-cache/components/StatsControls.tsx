...
export function StatsControls({ category, currency }: { category: StatsCategory; currency: Currency }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-zinc-200 bg-zinc-50 p-3 text-xs dark:border-zinc-800 dark:bg-zinc-900/50">
      <div className="space-y-1.5">
        ...
        <nav className="flex flex-wrap items-center gap-1.5" aria-label="currency 옵션 선택">
