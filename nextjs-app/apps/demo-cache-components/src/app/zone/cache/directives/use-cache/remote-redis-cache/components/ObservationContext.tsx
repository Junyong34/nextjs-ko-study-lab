...
import type { NestingViolationProbe, Observation, RequestObservation } from '../types'

interface ObservationStore {
  observations: Observation[]
  report: (obs: RequestObservation) => void
  reset: () => void
  nestingResult: NestingViolationProbe | null
  setNestingResult: (result: NestingViolationProbe) => void
}
...
export function ObservationProvider({ children }: { children: React.ReactNode }) {
  ...
  const [nestingResult, setNestingResult] = useState<NestingViolationProbe | null>(null)
  ...
  return (
    <ObservationContext.Provider value={{ observations, report, reset, nestingResult, setNestingResult }}>
      {children}
