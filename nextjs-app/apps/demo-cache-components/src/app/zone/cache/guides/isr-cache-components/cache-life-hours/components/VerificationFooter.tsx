...
export function VerificationFooter(props: VerificationFooterProps = {}) {
  ...
  const defaultExpected = "• Next.js 16 cacheLife('hours') 프로필 기반 수명 제어의 동작과 기대 결과를 확인합니다."
  ...
  return (
    <div className="space-y-4">
      <ExpectedActualPanel
        title="Next.js 16 cacheLife('hours') 프로필 기반 수명 제어 검증 결과"
      ...
      />
              ...
              <div className="space-y-3.5 text-xs leading-relaxed text-zinc-700 dark:text-zinc-300">
                <div>
                  ...
                  <p><code>cacheLife('hours')</code> 프로파일은 Next.js 16 Cache Components에서 레거시 <code>export const revalidate = 3600</code>을 완전히 대체하여, 시간 단위(수 시간)로 데이터 신선도를 유지하고 정기적인 백그라운드 revalidation을 수행하는 현대적 ISR 스펙입니다.</p>
                </div>
